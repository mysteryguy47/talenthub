...
- `GET /api/papers/{id}` - Get a paper
- `POST /api/papers` - Create a paper
- `POST /api/papers/preview` - Preview questions
- `POST /api/papers/generate-pdf` - Generate PDF
- `POST /api/papers/{id}/download` - Download PDF for saved paper
