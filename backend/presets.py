...
PRESETS = {
    ...
    "AB-7": [
        ...
        BlockConfig(id="ab7-4", type="multiplication", count=5, constraints=Constraints(multiplicandDigits=4, multiplierDigits=1), title="Multiplication 3×1"),
        BlockConfig(id="ab7-5", type="decimal_multiplication", count=5, constraints=Constraints(multiplicandDigits=1, multiplierDigits=1), title="Decimal Multiplication (1×1)"),
        BlockConfig(id="ab7-6", type="decimal_multiplication", count=5, constraints=Constraints(multiplicandDigits=2, multiplierDigits=1), title="Decimal Multiplication (1×1)"),
        ...
        BlockConfig(id="ab7-8", type="decimal_division", count=10, constraints=Constraints(dividendDigits=4, divisorDigits=1), title="Decimal Division (3÷1)"),
        ...
        BlockConfig(id="ab7-14", type="decimal_multiplication", count=5, constraints=Constraints(multiplicandDigits=1, multiplierDigits=1), title="Decimal Multiplication (1×1)"),
        ...
        BlockConfig(id="ab7-16", type="decimal_division", count=5, constraints=Constraints(dividendDigits=4, divisorDigits=2), title="Decimal Division (3÷2)"),
    ],
    "AB-8": [
        ...
        BlockConfig(id="ab8-3", type="decimal_multiplication", count=5, constraints=Constraints(multiplicandDigits=2, multiplierDigits=0), title="Multiplication 3×1"),
        BlockConfig(id="ab8-4", type="decimal_multiplication", count=5, constraints=Constraints(multiplicandDigits=3, multiplierDigits=1), title="Multiplication 3×1"),
        ...
        BlockConfig(id="ab8-6", type="decimal_division", count=5, constraints=Constraints(dividendDigits=4, divisorDigits=2), title="Decimal Multiplication (1×1)"),
        BlockConfig(id="ab8-7", type="gcd", count=10, constraints=Constraints(multiplicandDigits=2, multiplierDigits=1), title="Decimal Division (3÷1)"),
        BlockConfig(id="ab8-8", type="gcd", count=10, constraints=Constraints(multiplicandDigits=2, multiplierDigits=2), title="Decimal Division (3÷1)"),
        BlockConfig(id="ab8-9", type="lcm", count=10, constraints=Constraints(multiplicandDigits=2, multiplierDigits=1), title="Decimal Division (3÷2)"),
        BlockConfig(id="ab8-10", type="lcm", count=10, constraints=Constraints(multiplicandDigits=2, multiplierDigits=2), title="Decimal Division (4÷2)"),
        ...
        BlockConfig(id="ab8-13", type="decimal_multiplication", count=5, constraints=Constraints(multiplicandDigits=2, multiplierDigits=0), title="Multiplication 3×1"),
        ...
        BlockConfig(id="ab8-15", type="decimal_division", count=5, constraints=Constraints(dividendDigits=4, divisorDigits=1), title="Decimal Division (3÷2)"),
    ...
    "AB-9": [
        ...
        BlockConfig(id="ab9-3", type="decimal_multiplication", count=5, constraints=Constraints(multiplicandDigits=2, multiplierDigits=0), title="Multiplication 3×1"),
        BlockConfig(id="ab9-4", type="decimal_multiplication", count=5, constraints=Constraints(multiplicandDigits=3, multiplierDigits=1), title="Multiplication 3×1"),
        ...
        BlockConfig(id="ab9-6", type="decimal_division", count=5, constraints=Constraints(dividendDigits=4, divisorDigits=2), title="Decimal Multiplication (1×1)"),
        BlockConfig(id="ab9-7", type="gcd", count=5, constraints=Constraints(multiplicandDigits=2, multiplierDigits=1), title="Decimal Division (3÷1)"),
        BlockConfig(id="ab9-8", type="gcd", count=5, constraints=Constraints(multiplicandDigits=2, multiplierDigits=2), title="Decimal Division (3÷1)"),
        BlockConfig(id="ab9-9", type="lcm", count=5, constraints=Constraints(multiplicandDigits=2, multiplierDigits=1), title="Decimal Division (3÷2)"),
        BlockConfig(id="ab9-10", type="lcm", count=5, constraints=Constraints(multiplicandDigits=2, multiplierDigits=2), title="Decimal Division (4÷2)"),
        ...
        BlockConfig(id="ab9-13", type="decimal_add_sub", count=5, constraints=Constraints(digits=3, rows=3), title="Multiplication 3×1"),
        BlockConfig(id="ab9-14", type="decimal_multiplication", count=4, constraints=Constraints(multiplicandDigits=1, multiplierDigits=1), title="Decimal Multiplication (1×1)"),
        BlockConfig(id="ab9-15", type="decimal_division", count=4, constraints=Constraints(dividendDigits=4, divisorDigits=1), title="Decimal Division (3÷2)"),
        BlockConfig(id="ab9-16", type="gcd", count=4, constraints=Constraints(multiplicandDigits=1, multiplierDigits=2), title="GCD (1×2 digits)"),
        BlockConfig(id="ab9-17", type="lcm", count=4, constraints=Constraints(multiplicandDigits=2, multiplierDigits=2), title="Decimal Division (2÷1)"),
        BlockConfig(id="ab9-18", type="square_root", count=4, constraints=Constraints(rootDigits=4), title="Decimal Division (2÷1)"),
    ],
    "AB-10": [
